...
################################################## JAVA MAVEN ##################################################
docker run  -v "/home/ebiz/Bureau/docker-git/docker/maven_java_debian/src/:/src" -v "/home/ebiz/Bureau/docker-git/docker/maven_java_debian/war/:/war" --name="computerDatabaseInstance" maven_java_debian mvn -f "/src" clean package
